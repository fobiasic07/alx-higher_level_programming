...
ALTER TABLE hbtn_0c_0.first_name CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- Modifies the value of a row in a table in a specific database to character utf-8
ALTER TABLE htbn_0c_0.first_name MODIFY name VARCHAR(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
